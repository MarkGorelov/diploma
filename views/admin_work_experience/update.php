            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" name="company_name" placeholder="" value="<?php echo $workExperience['company_name']; ?>">

                        <p>Кем работал</p>
                        <input type="text" name="position" placeholder="" value="<?php echo $workExperience['position']; ?>">

                        <p>Год начала и окончания работы в компании</p>
                        <input type="text" name="date_of_experience" placeholder=""
                               value="<?php echo $workExperience['date_of_experience']; ?>">

                        <p>Краткое описание</p>
                        <input type="text" name="short_description" placeholder="" value="<?php echo $workExperience['short_description']; ?>">
                        ...
                        <select name="status">
                            ...
                            <option value="0" <?php if ($workExperience['status'] == 0) echo ' selected="selected"'; ?>>Скрыт
                            </option>
                        </select>
