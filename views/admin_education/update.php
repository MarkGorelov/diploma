            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" name="school_name" placeholder="" value="<?php echo $education['school_name']; ?>">

                        <p>Степень образования</p>
                        <input type="text" name="degree" placeholder="" value="<?php echo $education['degree']; ?>">
                        ...
                        <input type="text" name="date_of_education" placeholder="" value="<?php echo $education['date_of_education']; ?>">

                        <p>Краткое описание</p>
                        <input type="text" name="short_description" placeholder="" value="<?php echo $education['short_description']; ?>">
                        ...
                        <select name="status">
                            ...
                            <option value="0" <?php if ($education['status'] == 0) echo ' selected="selected"'; ?>>Скрыт
                            </option>
                        </select>
