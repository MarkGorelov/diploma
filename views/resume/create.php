    ...
    <form action="#" method="post" enctype="multipart/form-data">
        <header class="page-header bg-img" style="background-image: url(/template/img/bg-banner.jpg);">
            <div class="container page-name">
                ...
                <p class="lead text-center">Создайте резюме и разместите его на сайте</p>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <div class="form-group">
                            <input type="text" name="name" class="form-control input-lg" placeholder="Введите имя, фамилию">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-sm-6">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="website_address" class="form-control" placeholder="Ваш личный сайт">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xs-12 col-sm-6">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="salary" class="form-control" placeholder="Желаемый заработок">
                            ...
                            <div class="form-group col-xs-12 col-sm-6">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="email_address" class="form-control" placeholder="Адрес электронной почти">
                                </div>
                            </div>
